...
class SlidingPuzzleSolver:
    ...
    def run(self):
        ...
        while True:
            ...
            # Define square size and top-left/bottom-right corners
            square_size = 150
            ...
            showframe = frame
            cv2.circle(showframe, (center_x, center_y), 2, (0, 255, 0), -1)  # Blue filled circle
            cv2.rectangle(showframe, tl, br, (0, 255, 255), 1)  # Yellow square, thickness 2

            # Show camera feed
            cv2.imshow('Puzzle Solver - Camera Feed', showframe)
            ...
            if key == ord('c'):
                ...
                if state is not None:
                    ...
                    if self.is_valid_state(state):
                        print("\nSolving puzzle...")
                        cv2.putText(showframe, "THINKING...", (200,200), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 255), 1, cv2.LINE_AA)
                        ...
                        if solution:
                            ...
                            for coord in solution: # moving robot arm
                                pos = cell[coord-1]
                                epson.goto(x=pos[0], y=pos[1], z=pos[2]+10)
                                epson.goto(x=pos[0], y=pos[1], z=pos[2]-0.2)
                                epson.goto(x=pos[0], y=pos[1], z=pos[2]+10)
